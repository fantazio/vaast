...
and to_general_pattern : 'k . 'k general_pattern -> 'k OCaml.general_pattern = function _ -> failwith "Not implemented"

let to_pattern_data : to_pat_desc:('a -> 'b) -> 'a pattern_data -> 'b OCaml.pattern_data = fun ~to_pat_desc:_ -> failwith "Not implemented"
...
let to_open_infos : to_open_expr:('a -> 'b) -> 'a open_infos -> 'b OCaml.open_infos = fun ~to_open_expr:_ -> failwith "Not implemented"
...
let to_include_infos : to_incl_mod:('a -> 'b) -> 'a include_infos -> 'b OCaml.include_infos = fun ~to_incl_mod:_ -> failwith "Not implemented"
...
let to_class_infos : to_ci_expr:('a -> 'b) -> 'a class_infos -> 'b OCaml.class_infos = fun ~to_ci_expr:_ -> failwith "Not implemented"
